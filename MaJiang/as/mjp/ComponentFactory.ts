...
module mjp {
    ...
    export class ComponentFactory {
        ...
        private static function createAnGang(card:MjCard):MjComponent {
        ...
        public static createMingGangForHero(card:MjCard):MjComponent {
            var mc:MjComponent = createPengForHero(card);
            var mc4:Sprite = Asset.getFreezeCardMcDown(card);
            mc4.x = mc4.width;
            mc4.y = -14;
            mc.addChild(mc4);
        ...
        public static createMingGangForOther(card:MjCard):MjComponent {
            var mcc:MjComponent = createMingGangForHero(card);
            mcc.scaleX = mcc.scaleY = other_scale;
            return mcc;
        }
        ...
        public static createChiForHero(cc:MjCard[], target:MjCard = null):MjComponent {
            var cards:MjCard[] = cc.slice();
        ...
        public static createChiForOther(cards:MjCard[]):MjComponent {
            cards.sort(MjEngine.sortCardByNum);
            var mc:MjComponent = createChiForHero(cards);
            mc.scaleX = mc.scaleY = other_scale;
            return mc;
        }
    }
