...
module engine {
    ...
    import OptTing = engine.vo.OptTing;
    import OptFetch = engine.vo.OptFetch;
...
//            map[MjFan.fan_天听] = {a2: true, a4: true, func: MjFan.func_天听, tip: ""};
            map[MjFan.fan_大四喜] = {shape: "ag:|mg:|sh:|ke:|pe:东风,东风,东风,南风,南风,南风,西风,西风,西风,北风,北风,北风,四条,四条", fan: 88, a2: true, a4: true, func: MjFan.func_大四喜, ignore: [MjFan.fan_圈风刻, MjFan.fan_门风刻, MjFan.fan_三风刻, MjFan.fan_碰碰和, MjFan.fan_幺九刻, MjFan.fan_缺一门], tip: "胡牌时，所形成的牌之中有东、南、西、北四副刻子（杠）" };
            map[MjFan.fan_大三元] = {shape: "ag:|mg:|sh:|ke:|pe:红中,红中,红中,发财,发财,发财,白板,白板,白板,三万,四万,五万,四筒,四筒", fan: 88, a2: true, a4: true, func: MjFan.func_大三元, ignore: [MjFan.fan_箭刻, MjFan.fan_双箭刻, MjFan.fan_小三元, MjFan.fan_缺一门], tip: "胡牌时，所形成的牌之中有中、发、白三副刻子（杠）"};
            map[MjFan.fan_绿一色] = {shape: "ag:|mg:|sh:|ke:|pe:二条,三条,四条,二条,二条,二条,六条,六条,六条,八条,八条,八条,发财,发财", fan: 88, a2: false, a4: true, func: MjFan.func_绿一色, ignore: [MjFan.fan_混一色], tip: "由“23468”条及“发”字中的任何牌组成的胡牌" };
            map[MjFan.fan_九莲宝灯] = {shape: "ag:|mg:|sh:|ke:|pe:一万,一万,一万,一万,二万,三万,四万,五万,六万,七万,八万,九万,九万,九万", fan: 88, a2: true, a4: true, func: MjFan.func_九莲宝灯, ignore: [MjFan.fan_清一色, MjFan.fan_门前清, MjFan.fan_幺九刻, MjFan.fan_不求人, MjFan.fan_缺一门, MjFan.fan_无字], tip: "由一种花色序数牌组成的“1112345678999”组成的特定牌型，此时可以胡同花色的任意一张牌" };
            map[MjFan.fan_四杠] = {shape: "ag:|mg:七万,四筒,八筒,五条|sh:|ke:|pe:一筒,一筒", fan: 88, a2: true, a4: true, func: MjFan.func_四杠, ignore: [MjFan.fan_三杠, MjFan.fan_双暗杠, MjFan.fan_双明杠, MjFan.fan_明杠, MjFan.fan_暗杠, MjFan.fan_单钓将, MjFan.fan_碰碰和], tip: "胡牌时，牌中有4副杠牌" };
            map[MjFan.fan_连七对] = {shape: "ag:|mg:|sh:|ke:|pe:一万,一万,二万,二万,三万,三万,四万,四万,五万,五万,六万,六万,七万,七万", fan: 88, a2: true, a4: true, func: MjFan.func_连七对, ignore: [MjFan.fan_清一色, MjFan.fan_一般高, MjFan.fan_连六, MjFan.fan_门前清, MjFan.fan_七对, MjFan.fan_不求人, MjFan.fan_单钓将, MjFan.fan_缺一门, MjFan.fan_无字], tip: "由一种花色序数相连的七对牌形成的胡牌" };
            map[MjFan.fan_十三幺] = {shape: "ag:|mg:|sh:|ke:|pe:一万,九万,一筒,九筒,一条,九条,东风,南风,西风,北风,红中,发财,白板,白板", fan: 88, a2: false, a4: true, func: MjFan.func_十三幺, ignore: [MjFan.fan_五门齐, MjFan.fan_不求人, MjFan.fan_单钓将, MjFan.fan_全带幺, MjFan.fan_门前清], tip: "由三种序数牌的幺、九牌、七种字牌及其中一对作将组成的胡牌" };
            map[MjFan.fan_清幺九] = {shape: "ag:|mg:|sh:|ke:|pe:一万,一万,一万,九万,九万,九万,九筒,九筒,九筒,九条,九条,九条,一条,一条", fan: 64, a2: false, a4: true, func: MjFan.func_清幺九, ignore: [MjFan.fan_碰碰和, MjFan.fan_双同刻, MjFan.fan_无字, MjFan.fan_混幺九, MjFan.fan_全带幺, MjFan.fan_幺九刻], tip: "由序数牌幺、九刻子（杠）及将牌组成的胡牌" };
            map[MjFan.fan_小四喜] = {shape: "ag:|mg:|sh:|ke:|pe:东风,东风,东风,南风,南风,南风,西风,西风,西风,北风,北风,五条,五条,五条", fan: 64, a2: true, a4: true, func: MjFan.func_小四喜, ignore: [MjFan.fan_三风刻, MjFan.fan_幺九刻, MjFan.fan_缺一门], tip: "胡牌时，牌中有三个风牌的刻子（杠），另外一个风牌作将牌" };
            map[MjFan.fan_小三元] = {shape: "ag:|mg:|sh:|ke:|pe:红中,红中,红中,发财,发财,发财,白板,白板,五筒,五筒,五筒,八筒,八筒,八筒", fan: 64, a2: true, a4: true, func: MjFan.func_小三元, ignore: [MjFan.fan_箭刻, MjFan.fan_双箭刻, MjFan.fan_缺一门], tip: "胡牌时，牌中有两个箭牌的刻子（杠），另外一个箭牌作将牌" };
            map[MjFan.fan_字一色] = {shape: "ag:|mg:|sh:|ke:|pe:南风,南风,南风,东风,东风,东风,北风,北风,北风,发财,发财,发财,红中,红中", fan: 64, a2: true, a4: true, func: MjFan.func_字一色, ignore: [MjFan.fan_碰碰和, MjFan.fan_混幺九, MjFan.fan_全带幺, MjFan.fan_幺九刻, MjFan.fan_缺一门], tip: "由字牌的刻子（杠）。将牌组成的胡牌" };
            map[MjFan.fan_四暗刻] = {shape: "ag:|mg:|sh:|ke:|pe:七万,七万,七万,四万,四万,四万,五筒,五筒,五筒,五条,五条,五条,七条,七条", fan: 64, a2: true, a4: true, func: MjFan.func_四暗刻, ignore: [MjFan.fan_门前清, MjFan.fan_碰碰和, MjFan.fan_三暗刻, MjFan.fan_双暗刻, MjFan.fan_不求人], tip: "胡牌时牌中有四副暗刻（暗杠）" };
            map[MjFan.fan_一色双龙会] = {shape: "ag:|mg:|sh:|ke:|pe:一条,二条,三条,一条,二条,三条,五条,五条,七条,八条,九条,七条,九条,八条", fan: 64, a2: true, a4: true, func: MjFan.func_一色双龙会, ignore: [MjFan.fan_平和, MjFan.fan_七对, MjFan.fan_清一色, MjFan.fan_一般高, MjFan.fan_老少副], tip: "一种花色的两套老少副（即有两组123、789）以及一套5作将牌" };
            map[MjFan.fan_一色四同顺] = {shape: "ag:|mg:|sh:|ke:|pe:一筒,一筒,一筒,二筒,二筒,二筒,三筒,三筒,三筒,四筒,四筒,四筒,一条,一条", fan: 48, a2: true, a4: true, func: MjFan.func_一色四同顺, ignore: [MjFan.fan_一色三节高, MjFan.fan_一般高, MjFan.fan_四归一, MjFan.fan_一色三同顺, MjFan.fan_七对], tip: "一种花色四副序数相同的顺子" };
            map[MjFan.fan_一色四节高] = {shape: "ag:|mg:|sh:|ke:|pe:一万,一万,一万,二万,二万,二万,三万,三万,三万,四万,四万,四万,六条,六条", fan: 48, a2: true, a4: true, func: MjFan.func_一色四节高, ignore: [MjFan.fan_一色三同顺, MjFan.fan_一色三节高, MjFan.fan_碰碰和], tip: "一种花色一次递增一个序数的四个刻子（杠）" };
            map[MjFan.fan_一色四步高] = {shape: "ag:|mg:|sh:|ke:|pe:二万,三万,四万,三万,四万,五万,四万,五万,六万,五万,六万,七万,南风,南风", fan: 32, a2: true, a4: true, func: MjFan.func_一色四步高, ignore: [MjFan.fan_一色三步高], tip: "一种花色一次递增一个或者两个序数的顺子"};
            map[MjFan.fan_三杠] = {shape: "ag:|mg:三筒,六筒,五条|sh:|ke:|pe:一万,二万,三万,东风,东风", fan: 32, a2: true, a4: true, func: MjFan.func_三杠, ignore: [MjFan.fan_双明杠, MjFan.fan_双暗杠, MjFan.fan_明杠, MjFan.fan_暗杠], tip: "胡牌时，牌中有三副杠牌"};
            map[MjFan.fan_混幺九] = {shape: "ag:|mg:|sh:|ke:|pe:一万,一万,一万,一筒,一筒,一筒,九万,九万,九万,东风,东风,东风,南风,南风", fan: 32, a2: true, a4: true, func: MjFan.func_混幺九, ignore: [MjFan.fan_碰碰和, MjFan.fan_幺九刻, MjFan.fan_全带幺], tip: "由字牌和序数牌一、九的刻子（杠）、将牌形成的和牌；其中肯定包含字牌"};
            map[MjFan.fan_七对] = {shape: "ag:|mg:|sh:|ke:|pe:二万,二万,四万,四万,八万,八万,四筒,四筒,六筒,六筒,九筒,九筒,五条,五条", fan: 24, a2: true, a4: true, func: MjFan.func_七对, ignore: [MjFan.fan_不求人, MjFan.fan_单钓将], tip: "由7个对子组成的和牌"};
            map[MjFan.fan_七星不靠] = {shape: "ag:|mg:|sh:|ke:|pe:东风,南风,西风,北风,红中,发财,白板,一万,四万,七万,二筒,五筒,八筒,三条", fan: 24, a2: false, a4: true, func: MjFan.func_七星不靠, ignore: [MjFan.fan_五门齐, MjFan.fan_门前清, MjFan.fan_全不靠, MjFan.fan_单钓将], tip: "必须有7个单张的东、南、西、北、中、发、白，加上三种花色数位按照147、258、369中的7张序数牌组成的没有将牌的和牌" };
            map[MjFan.fan_全双刻] = {shape: "ag:|mg:|sh:|ke:|pe:四筒,四筒,四筒,四条,四条,四条,六条,六条,六条,八万,八万,八万,六筒,六筒", fan: 24, a2: false, a4: true, func: MjFan.func_全双刻, ignore: [MjFan.fan_碰碰和, MjFan.fan_断幺], tip: "由“2468”序数牌的刻子（杠）、将牌组成的和牌"};
            map[MjFan.fan_清一色] = {shape: "ag:|mg:|sh:|ke:|pe:一筒,二筒,三筒,一筒,二筒,三筒,四筒,五筒,六筒,七筒,八筒,九筒,九筒,九筒", fan: 24, a2: true, a4: true, func: MjFan.func_清一色, ignore: [MjFan.fan_无字], tip: "由同一种花色组成的和牌"};
            map[MjFan.fan_一色三同顺] = {shape: "ag:|mg:|sh:|ke:|pe:一万,二万,三万,三万,三万,二万,二万,一万,一万,四筒,五筒,六筒,五条,五条", fan: 24, a2: true, a4: true, func: MjFan.func_一色三同顺, ignore: [MjFan.fan_一色三节高, MjFan.fan_一般高], tip: "和牌中，有一种花色三副序数相同的顺子"};
            map[MjFan.fan_一色三节高] = {shape: "ag:|mg:|sh:|ke:|pe:四筒,四筒,四筒,五筒,五筒,五筒,六筒,六筒,六筒,七万,八万,九万,东风,东风", fan: 24, a2: true, a4: true, func: MjFan.func_一色三节高, ignore: [MjFan.fan_一色三同顺], tip: "和牌中，有一种花色三副序数依次递增一个序数的刻子（杠）"};
            map[MjFan.fan_全大] = {shape: "ag:|mg:|sh:|ke:|pe:七万,八万,九万,七筒,八筒,九筒,七条,七条,七条,九筒,九筒,九筒,九条,九条", fan: 24, a2: false, a4: true, func: MjFan.func_全大, ignore: [MjFan.fan_无字], tip: "由序数牌7、8、9组成的和牌"};
            map[MjFan.fan_全中] = {shape: "ag:|mg:|sh:|ke:|pe:四筒,五筒,六筒,五筒,五筒,五筒,四条,五条,六条,六万,六万,六万,五万,五万", fan: 24, a2: false, a4: true, func: MjFan.func_全中, ignore: [MjFan.fan_无字, MjFan.fan_断幺], tip: "由序数牌4、5、6组成的和牌"};
            map[MjFan.fan_全小] = {shape: "ag:|mg:|sh:|ke:|pe:一条,二条,三条,三条,三条,三条,一万,二万,三万,一筒,一筒,一筒,二筒,二筒", fan: 24, a2: false, a4: true, func: MjFan.func_全小, ignore: [MjFan.fan_无字], tip: "由序数牌1、2、3组成的和牌"};
            map[MjFan.fan_清龙] = {shape: "ag:|mg:|sh:|ke:|pe:一筒,二筒,三筒,四筒,五筒,六筒,七筒,八筒,九筒,四条,四条,四条,东风,东风", fan: 16, a2: true, a4: true, func: MjFan.func_清龙, ignore: [MjFan.fan_连六, MjFan.fan_老少副], tip: "和牌中，有同花色123 456 789相连的序数牌"};
            map[MjFan.fan_三色双龙会] = {shape: "ag:|mg:|sh:|ke:|pe:一万,二万,三万,七万,八万,九万,一筒,二筒,三筒,七筒,八筒,九筒,五条,五条", fan: 16, a2: false, a4: true, func: MjFan.func_三色双龙会, ignore: [MjFan.fan_喜相逢, MjFan.fan_老少副, MjFan.fan_无字, MjFan.fan_平和], tip: "两种花色两副老少副，另外一种花色一对5作为将牌形成的和牌" };
            map[MjFan.fan_一色三步高] = {shape: "ag:|mg:|sh:|ke:|pe:二万,三万,四万,三万,四万,五万,四万,五万,六万,五筒,五筒,五筒,九筒,九筒", fan: 16, a2: true, a4: true, func: MjFan.func_一色三步高, tip: "和牌中，有一种花色三副依次递增一个或者两个的顺子"};
            map[MjFan.fan_全带五] = {shape: "ag:|mg:|sh:|ke:|pe:四筒,五筒,六筒,五条,五条,五条,四万,五万,六万,六万,五万,七万,五筒,五筒", fan: 16, a2: false, a4: true, func: MjFan.func_全带五, ignore: [MjFan.fan_断幺], tip: "每副牌及将牌必须带有序数牌5"};
            map[MjFan.fan_三同刻] = {shape: "ag:|mg:|sh:|ke:|pe:四万,四万,四万,四筒,四筒,四筒,四条,四条,四条,六条,七条,八条,东风,东风", fan: 16, a2: false, a4: true, func: MjFan.func_三同刻, tip: "和牌中，有3副序数相同的刻子（杠）"};
            map[MjFan.fan_三暗刻] = {shape: "ag:|mg:|sh:|ke:|pe:三万,三万,三万,五筒,五筒,五筒,九筒,九筒,九筒,五条,六条,七条,东风,东风", fan: 16, a2: true, a4: true, func: MjFan.func_三暗刻, ignore: [MjFan.fan_双暗刻], tip: "和牌中，有3副暗刻（暗杠）"};
            map[MjFan.fan_全不靠] = {shape: "ag:|mg:|sh:|ke:|pe:一万,四万,七万,二筒,五筒,八筒,三条,六条,九条,东风,南风,西风,北风,红中", fan: 12, a2: false, a4: true, func: MjFan.func_全不靠, ignore: [MjFan.fan_门前清, MjFan.fan_五门齐, MjFan.fan_不求人, MjFan.fan_单钓将], tip: "由三种花色147、258、369不能错位的序数牌及东、南、西、北、中、发、白中的任意十四张单张牌组成的和牌"};
            map[MjFan.fan_组合龙] = {shape: "ag:|mg:|sh:|ke:|pe:一万,四万,七万,二筒,五筒,八筒,三条,六条,九条,七筒,八筒,九筒,八万,八万", fan: 12, a2: false, a4: true, func: MjFan.func_组合龙, tip: "和牌中，有三种花色147、258、369不能错位的序数牌（特殊顺子）"};
            map[MjFan.fan_大于五] = {shape: "ag:|mg:|sh:|ke:|pe:六万,七万,八万,九万,九万,九万,六筒,六筒,六筒,七筒,八筒,九筒,九条,九条", fan: 12, a2: true, a4: true, func: MjFan.func_大于五, ignore: [MjFan.fan_无字], tip: "由序数牌6、7、8、9组成的和牌"};
            map[MjFan.fan_小于五] = {shape: "ag:|mg:|sh:|ke:|pe:一筒,二筒,三筒,二筒,二筒,二筒,一万,一万,一万,二条,三条,四条,三条,三条", fan: 12, a2: true, a4: true, func: MjFan.func_小于五, ignore: [MjFan.fan_无字], tip: "由序数牌1、2、3、4组成的和牌"};
            map[MjFan.fan_三风刻] = {shape: "ag:|mg:|sh:|ke:|pe:东风,东风,东风,南风,南风,南风,西风,西风,西风,一条,二条,三条,五筒,五筒", fan: 12, a2: true, a4: true, func: MjFan.func_三风刻, tip: "和牌中，有三副风刻（杠）"};
            map[MjFan.fan_花龙] = {shape: "ag:|mg:|sh:|ke:|pe:一万,二万,三万,四筒,五筒,六筒,七条,八条,九条,九筒,九筒,九筒,三筒,三筒", fan: 8, a2: false, a4: true, func: MjFan.func_花龙, tip: "和牌中，有三种花色123、456、789三个顺子连接而成"};
            map[MjFan.fan_推不倒] = {shape: "ag:|mg:|sh:|ke:|pe:一筒,二筒,三筒,四筒,四筒,四筒,四条,四条,四条,六条,六条,六条,八条,八条", fan: 8, a2: false, a4: true, func: MjFan.func_推不倒, ignore: [MjFan.fan_缺一门], tip: "由牌面图形没有上下区别的牌组成的和牌。包括1234589饼、245689条、白板"};
            map[MjFan.fan_三色三同顺] = {shape: "ag:|mg:|sh:|ke:|pe:一万,二万,三万,一筒,二筒,三筒,一条,二条,三条,九筒,九筒,九筒,五筒,五筒", fan: 8, a2: false, a4: true, func: MjFan.func_三色三同顺, tip: "和牌中，有三种花色三副序数相同的顺子"};
            map[MjFan.fan_三色三节高] = {shape: "ag:|mg:|sh:|ke:|pe:四筒,四筒,四筒,五条,五条,五条,六万,六万,六万,一万,二万,三万,九条,九条", fan: 8, a2: false, a4: true, func: MjFan.func_三色三节高, tip: "和牌中，有三种花色三副依次递增一个序数的刻子（杠）"};
            //map[MjFan.fan_无番] = {shape:"",a2: false, a4: true, func: null, tip:"和牌中，数不出任何番种番（不包含花牌）"};
            map[MjFan.fan_妙手回春] = {shape: "", fan: 8, a2: true, a4: true, func: MjFan.func_妙手回春, ignore: [MjFan.fan_自摸], tip: "自模牌墙上最后一张牌形成和牌"};
            map[MjFan.fan_海底捞月] = {shape: "", fan: 8, a2: true, a4: true, func: MjFan.func_海底捞月, tip: "和别人打出的最后一张牌"};
            map[MjFan.fan_杠上开花] = {shape: "", fan: 8, a2: true, a4: true, func: MjFan.func_杠上开花, ignore: [MjFan.fan_自摸], tip: "杠牌时，从牌墙上补上一张牌形成和牌"};
            map[MjFan.fan_抢杠和] = {shape: "", fan: 8, a2: true, a4: true, func: MjFan.func_抢杠和, ignore: [MjFan.fan_和绝张], tip: "和他人自抓开明杠的牌"};
            map[MjFan.fan_碰碰和] = {shape: "ag:|mg:|sh:|ke:二万,三筒,五筒,八筒|pe:五条,五条", fan: 6, a2: true, a4: true, func: MjFan.func_碰碰和, tip: "由4副刻子（杠），将牌组成的和牌"};
            map[MjFan.fan_混一色] = {shape: "ag:|mg:|sh:|ke:|pe:一万,二万,三万,五万,五万,五万,七万,八万,九万,东风,东风,东风,红中,红中", fan: 6, a2: true, a4: true, func: MjFan.func_混一色, tip: "由一种花色序数牌及字牌组成的和牌"};
            map[MjFan.fan_三色三步高] = {shape: "ag:|mg:|sh:|ke:|pe:二万,三万,四万,三条,四条,五条,四筒,五筒,六筒,六条,六条,六条,九条,九条", fan: 6, a2: false, a4: true, func: MjFan.func_三色三步高, tip: "和牌中，有三种花色三副依次递增一个序数的顺子" };
            map[MjFan.fan_五门齐] = {shape: "", fan: 6, a2: false, a4: true, func: MjFan.func_五门齐, tip: "由一种花色序数牌及字牌组成的和牌"};
            map[MjFan.fan_全求人] = {shape: "", fan: 6, a2: true, a4: true, func: MjFan.func_全求人, ignore: [MjFan.fan_单钓将], tip: "4副牌全部是吃、碰（明杠）他们的牌，且最后和牌也是和他人打出的牌"};
            map[MjFan.fan_双暗杠] = {shape: "", fan: 6, a2: true, a4: true, func: MjFan.func_双暗杠, ignore: [MjFan.fan_暗杠, MjFan.fan_双暗刻], tip: "和牌中，有两副暗杠"};
            map[MjFan.fan_双箭刻] = {shape: "", fan: 6, a2: true, a4: true, func: MjFan.func_双箭刻, ignore: [MjFan.fan_箭刻], tip: "和牌中，有两副箭刻"};
            map[MjFan.fan_全带幺] = {shape: "", fan: 4, a2: true, a4: true, func: MjFan.func_全带幺, tip: "每副牌及将牌中都带有幺九牌"};
            map[MjFan.fan_不求人] = {shape: "", fan: 4, a2: true, a4: true, func: MjFan.func_不求人, ignore: [MjFan.fan_门前清, MjFan.fan_自摸], tip: "没有吃牌、碰牌、明杠，最后自模和牌" };
            map[MjFan.fan_双明杠] = {shape: "", fan: 4, a2: true, a4: true, func: MjFan.func_双明杠, ignore: [MjFan.fan_明杠], tip: "和牌之中有两个明杠"};
            map[MjFan.fan_和绝张] = {shape: "", fan: 4, a2: true, a4: true, func: MjFan.func_和绝张, tip: "和牌池、桌面已亮明3张所剩第4张相同的牌"};
            map[MjFan.fan_箭刻] = {shape: "", fan: 2, a2: true, a4: true, func: MjFan.func_箭刻, tip: "由中、发、白3张相同的牌组成的刻子（杠）"};
            ...
            map[MjFan.fan_双同刻] = {shape: "", fan: 2, a2: false, a4: true, func: MjFan.func_双同刻, tip: "和牌中，有2副序数相同的刻子（杠）"};
            ...
            map[MjFan.fan_一般高] = {shape: "", fan: 1, a2: true, a4: true, func: MjFan.func_一般高, tip: "在和牌时，有2副由一种花色序数相同的顺子组成的牌"};
            map[MjFan.fan_喜相逢] = {shape: "", fan: 1, a2: false, a4: true, func: MjFan.func_喜相逢, tip: "在和牌时，有2副不同花色序数相同的顺子组成的牌"};
            map[MjFan.fan_连六] = {shape: "", fan: 1, a2: true, a4: true, func: MjFan.func_连六, tip: "在和牌时，有一种花色序数相连的6张牌组成的2副顺子"};
            map[MjFan.fan_老少副] = {shape: "", fan: 1, a2: true, a4: true, func: MjFan.func_老少副, tip: "在和牌时，有一种花色的123、789组成的顺子"};
            map[MjFan.fan_幺九刻] = {shape: "", fan: 1, a2: true, a4: true, func: MjFan.func_幺九刻, tip: "在和牌时，有三张相同的幺九牌、字牌组成的刻子（杠）"};
            map[MjFan.fan_明杠] = {shape: "", fan: 1, a2: true, a4: true, func: MjFan.func_明杠, tip: "他人打出一张与暗刻相同的牌开杠；或者自己抓入一张与明刻相同的牌开杠"};
